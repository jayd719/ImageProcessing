...
def calculate_histogram_values(img):
    """
    -------------------------------------------------------
    Calculates the histogram, cumulative frequency, and new pixel values for
    histogram equalization of a grayscale image. These values are used to map
    the original pixel intensities to new equalized values.
    Use: hist, cum_freq, new_pixel = calculate_histogram_values(img)
    -------------------------------------------------------
    Parameters:
        img - the input grayscale image represented as a NumPy array (ndarray)
    Returns:
        hist - the histogram of the image (ndarray of int)
        cum_freq - the cumulative frequency (CDF) of the histogram (ndarray of int)
        new_pixel - the equalized pixel values based on the cumulative frequency (ndarray of int)
    -------------------------------------------------------
    """
    ...
    return hist, cum_freq, new_pixel
...
def histogram_equalization(img):
    ...
    hist, cum_freq, new_pixel = calculate_histogram_values(img)
...
def histogram_specification(source_image, img):
    """
    -------------------------------------------------------
    Performs histogram specification or matching on an input image using a
    source image.
    Use: new_image = histogram_specification(source_image, img)
    -------------------------------------------------------
    Parameters:
        source_image - the image whose histogram will be matched (ndarray)
        img - the input image to be transformed (ndarray)
    Returns:
        new_image - the input image transformed to match the histogram of the source image (ndarray)
    -------------------------------------------------------
    """
    _, _, new_pixel = calculate_histogram_values(source_image)
    # Numpy array to store new image
    new_image = zeros([img.shape[0], img.shape[1]], dtype=img.dtype)
